...
export function mapXeroInvoices(row: Record<string, unknown>) {
  return {
    ...
    lineitem_description: row.col_4 as string | null,
    lineitem_id: row.col_5 as string | null,
    ...
    total_amount_in_home_currency: row.col_19 as number | null,
    amount_paid_in_home_currency: row.col_20 as number | null,
    amount_due_in_home_currency: row.col_21 as number | null,
  }
}
...
export function mapLoxoDeals(row: Record<string, unknown>) {
  return {
    ...
    title: row.col_20 as string | null,
    company: row.col_21 as string | null,
